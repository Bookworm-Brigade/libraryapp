  ...
  return (
    <div className='w-[60rem] h-[25rem] ml-[12rem] rounded-3xl border-4 border-[#800000] flex flex-col justify-center  '>
      ...
      <div className='flex flex-col ml-30'>
       ...
       <button><span className='text-xs'>Download on the  </span> <br /> 
      
       <span className='text-sm flex flex-row'> <FaApple />App Store</span></button>
      
       </span>
       <span className='border-2 bg-[#800000] w-35 h-13 flex pl-8 pb-5 text-white rounded-lg'>
       <button><span className='text-xs'> GET IT ON </span><br /> <span className='text-sm flex flex-row'><FaGooglePlay />Google Play </span> </button>
       </span>
      </div>
